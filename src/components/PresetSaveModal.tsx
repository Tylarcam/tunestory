...
import { validatePresetName, createPresetObject } from "@/lib/presetManager";
...
export function PresetSaveModal({
  ...
  const handleSave = () => {
    ...
    const preset = createPresetObject(name, currentState);
    onSave(preset);
    onOpenChange(false);
  };
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2 rounded-lg border border-border/50 bg-muted/30 p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li>Genre: {currentState.genre || "None"}</li>
